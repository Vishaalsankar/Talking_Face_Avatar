...
parser.add_argument("-p", "--pred-path", type=str, help="Predictor Path", default=r'C:/Users/pavit/tf_env/main/data/dlib_data/shape_predictor_68_face_landmarks.dat')
parser.add_argument("-ti", "--temp-img", type=str, help="Template face image path", default=r'C:\Users\pavit\tf_env\main\data_prep\template_face.jpg')
